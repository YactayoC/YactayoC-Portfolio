...
export const dataSkills: Skill[] = [
  ...
  {
    name: 'TypeScript',
    image: 'https://res.cloudinary.com/sebas-2001-yac/image/upload/v1662226893/portfolio/Icons/typescript_hvpgz0.png',
    category: 'frontend',
  },
  {
    name: 'React',
  ...
  {
    name: 'Docker',
    image: 'https://res.cloudinary.com/sebas-2001-yac/image/upload/v1680793541/portfolio/Icons/docker_p4dggs.png',
    category: 'others',
  },
];
