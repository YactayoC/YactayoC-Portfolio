export const dataProjects = [
  ...
  },
  {
    ...
    category: 'external',
    description_en:
      "GiphyAPI is a project that uses an external API like Giphy's in which requests are made to get alteatory gifs as well as searchable gifs. In addition to having a filter by categories.",
    description_es:
