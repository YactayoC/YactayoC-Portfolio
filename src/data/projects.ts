...
export const dataProjects: ProjectI[] = [
  ...
  },
  {
    ...
    title: 'Task Manager',
    images: [
      'https://res.cloudinary.com/sebas-2001-yac/image/upload/v1680795248/portfolio/task-1_bl2659.png',
      'https://res.cloudinary.com/sebas-2001-yac/image/upload/v1680795248/portfolio/task-2_bszama.png',
      'https://res.cloudinary.com/sebas-2001-yac/image/upload/v1680795248/portfolio/task-3_qch2rf.png',
      'https://res.cloudinary.com/sebas-2001-yac/image/upload/v1680795248/portfolio/task-4_at1vp2.png',
    ],
    technologies: [
      {
        name: 'HTML',
      ...
      {
        name: 'Vue',
        image: 'https://res.cloudinary.com/sebas-2001-yac/image/upload/v1680794091/portfolio/Icons/vue.png',
        category: 'frontend',
      },
      {
        name: 'VueX',
    ...
    repository: 'https://github.com/YactayoC/Task-Manager',
    video:
      'https://res.cloudinary.com/sebas-2001-yac/video/upload/v1659745028/portfolio/Videos/2022-08-05_19-16-00_iwz9b3.mp4',
    url: 'https://task-manager-vue.netlify.app/',
    salient: true,
    category: 'own',
    description_en:
      'Task Manager is a basic project made in vue in which we can manage our tasks and their relevance. This project works with vuex through the localstorage.',
    description_es:
      'Task Manager is a basic project made in vue in which we can manage our tasks and their relevance. This project works with vuex through the localstorage.',
  },
];
